...
//Push状態
bool InputManager::IsPushKey(uint8_t keyNumber) {
...
//トリガー
bool InputManager::IsTriggerKey(uint8_t keyNumber) {
...
#pragma region マウス
//Push状態
bool InputManager::IsPushMouse(int32_t mouseNumber) {
...
//Trigger状態
bool InputManager::IsTriggerMouse(int32_t mouseNumber) {
...
//状態を取得
bool InputManager::GetJoystickState(XINPUT_STATE& state){
...
bool InputManager::IsPushLeft(XINPUT_STATE& state) {
...
bool InputManager::IsPushRight(XINPUT_STATE& state) {
